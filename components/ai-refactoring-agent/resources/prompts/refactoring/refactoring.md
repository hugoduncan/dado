...
3. How the change preserves behavior
...
a potential change, ask for clarification rather than making assumptions.

Focus on one area of improvement at a time. Suggest smaller, incremental
changes rather than large restructurings.

Do not propose changes that would modify the external behavior or APIs
