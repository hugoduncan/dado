You will help implement a system, package or component to fulfill a
given scope and to have specified features, with a given archicture.
...
the scope of what is being implemented.
